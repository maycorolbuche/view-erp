...
@section('content')
    <x-content>
        ...
        <x-panel title="Formulário">
            ...
            @include('civil-statuses.components.header', ['civil_status' => isset($data) ? $data : null])

            @include('layouts.partials.messages')

            <x-form action-name="civil-statuses" action-id="{{ isset($data) ? $data->id_civil_status : null }}">
                <x-group>
                ...
                <x-group right>
                    ...
                    <x-button type="cancel" route-name="civil-statuses" />
                </x-group>
        ...
        <x-panel title="Dados">
            @include('civil-statuses.components.datatable', ['route' => 'civil-statuses.show'])
        </x-panel>
    </x-content>
@endsection
