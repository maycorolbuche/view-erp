        ...
        <ul class="nav sidebar-menu">
                ...
                <ul class="nav sub-nav">
                    <li>
                        <a href="ecommerce_dashboard.html">
                            <span class="glyphicons glyphicons-shopping_cart"></span> Dashboard <span
                                class="label label-xs bg-primary">New</span></a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-nav">
                    <li>
                        <a href="ui_tour.html">
                            <span class="glyphicons glyphicons-lightbulb"></span> Tour <span
                                class="label label-xs bg-primary">New</span> </a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav sub-nav">
                    <li>
                        ...
                        <ul class="nav sub-nav">
                            <li>
                                <a href="landing-page/landing1/index.html" target="_blank"> Landing Page <span
                                        class="label label-xs bg-primary">New</span> </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="pages_coming-soon.html"> Coming Soon <span
                                        class="label label-xs bg-primary">New</span> </a>
                            </li>
                            <li>
