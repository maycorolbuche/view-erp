...
@section('content')
    <x-content>
        ...
        <x-panel title="Formulário">
            ...
            @include('employment-types.components.header', [
                'employment_type' => isset($data) ? $data : null,
            ])

            @include('layouts.partials.messages')

            <x-form action-name="employment-types" action-id="{{ isset($data) ? $data->id_employment_type : null }}">
                <x-group>
                ...
                <x-group right>
                    ...
                    <x-button type="cancel" route-name="employment-types" />
                </x-group>
        ...
        <x-panel title="Dados">
            @include('employment-types.components.datatable', ['route' => 'employment-types.show'])
        </x-panel>
    </x-content>
@endsection
