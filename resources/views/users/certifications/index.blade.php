...
@section('content')
    ...
    <x-content>
        ...
        <x-panel title="Formulário" type="primary">
            ...
            <x-form action-name="users-certifications" action-id="{{ isset($data) ? $data->id_user_certification : null }}"
                action-pid="{{ $pid }}">
                <x-group>
                ...
                <x-group right>
                    ...
                    @if (isset($data))
                        <x-button type="cancel" route="{{ route('users-certifications.index', ['pid' => $pid]) }}" />
                    @else
                        <x-button type="cancel" route-name="users-certifications" />
                    @endif
                </x-group>
            ...
            <x-panel title="Lista de Pagamentos" type="success">
                <x-data-table data-origin="users-certifications.datatable" pid={{ $pid }}
        ...
        <x-panel title="Dados" type="warning">
            @include('users.components.datatable', [
                'route' => 'users-certifications.index',
                'field' => 'pid',
            ])
        </x-panel>
    </x-content>
