...
class EmploymentTypeController extends Controller
{
    ...
    public function store(EmploymentTypeRequest $request)
    {
        ...
        try {
            $employment_type = EmploymentType::create($request->all());
            return redirect()->route('employment-types.show', ['id' => $employment_type->id_employment_type])->with('success', 'Registro cadastrado com sucesso');
        } catch (\Exception $e) {
    ...
    public function show($id)
    {
        ...
        if ($data) {
            return view('employment-types.index', compact('data'));
        } else {
            return redirect()->route('employment-types')->with('error', 'Registro não encontrado!');
        }
    }
    ...
    public function update(EmploymentTypeRequest $request, $id)
    {
        ...
        if ($request->_action == "store") {
            $id = null;
            $storeRequest = new EmploymentTypeRequest();
        ...
        try {
            ...
            if ($employment_type) {
                ...
                return redirect()->route('employment-types.show', ['id' => $employment_type->id_employment_type])->with('success', 'Registro salvo com sucesso');
            } else {
                return redirect()->route('employment-types')->with('error', 'Registro não encontrado!');
            }
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            if ($employment_type) {
                ...
                return redirect()->route('employment-types')->with('success', 'Registro apagado com sucesso');
            } else {
                return redirect()->route('employment-types')->with('error', 'Registro não encontrado!');
            }
        } catch (\Exception $e) {
